...
const RemoveUserMenuItem = ({
  ...
  return (
    <MenuItem>
      {() => (
        <button
          className={`min-h-8 cursor-pointer mt-1 py-0.5 w-full text-sm ${isRtl ? 'text-right' : 'text-left'} leading-none font-medium text-Red-600 px-3 rounded-lg transition-all duration-300 hover:bg-Red-600 hover:text-white`}
