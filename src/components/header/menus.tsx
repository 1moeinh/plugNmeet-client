...
const HeaderMenus = ({ onOpenAlert }: IHeaderMenusProps) => {
  ...
  return (
    <MenuItems
      unmount={false}
      className="HeaderSettingMenu origin-top-right z-50 bg-white absolute ltr:right-0 rtl:left-1 mt-2 w-[244px] shadow-dropdown-menu rounded-[15px] overflow-hidden border border-Gray-100 p-2 ring-0 focus:outline-hidden"
    >
